...
SENSORS: tuple[XinaoGasSensorDescription, ...] = (
    ...
    XinaoGasSensorDescription(key="current_month_usage", translation_key="current_month_usage", native_unit_of_measurement=UnitOfVolume.CUBIC_METERS, device_class=SensorDeviceClass.GAS, icon="mdi:fire", state_class=SensorStateClass.MEASUREMENT),
    ...
    XinaoGasSensorDescription(key="last_meter_reading", translation_key="last_meter_reading", native_unit_of_measurement=UnitOfVolume.CUBIC_METERS, device_class=SensorDeviceClass.GAS, icon="mdi:counter", state_class=SensorStateClass.MEASUREMENT),
    ...
    XinaoGasSensorDescription(key="month_total_gas", translation_key="month_total_gas", native_unit_of_measurement=UnitOfVolume.CUBIC_METERS, device_class=SensorDeviceClass.GAS, icon="mdi:fire-circle", state_class=SensorStateClass.MEASUREMENT),
    XinaoGasSensorDescription(key="daily_usage", translation_key="daily_usage", native_unit_of_measurement=UnitOfVolume.CUBIC_METERS, device_class=SensorDeviceClass.GAS, icon="mdi:calendar-today", state_class=SensorStateClass.MEASUREMENT),
